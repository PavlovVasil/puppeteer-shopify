...
const getUrlsForSection = async (sectionUrl) => {
    const expertsListPage = await browser.newPage();
    await browser.goto(sectionUrl);
    await expertsList.waitForSelector('_12oDh');
    const content = await expertsListPage.content();
...
(async () => {
    try {
        ...
        const baseSectionUrl = 'https://experts.shopify.com/services/visual-content-and-branding/develop-brand-look-and-feel?page=18';
